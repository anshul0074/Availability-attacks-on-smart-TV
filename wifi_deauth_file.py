...
# empty list for all active wireless networks
...
for file_name in os.listdir():
    if ".csv" in file_name:
        ...
        try:
            ...
            print("\033[4m [+] Backup folder exists.")
...
wlan_pattern = re.compile("wlp0s20f3")
...
# The script is the parent process and creates a child p`rocess which runs the system command, and will only continue once the child process has completed.
# We run the iwconfig command to look for wireless interfaces.
check_wifi_result = wlan_pattern.findall(subprocess.run(["iwconfig"], capture_output=True).stdout.decode())

# No WiFi Adapter connected.
if len(check_wifi_result) == 0:
    print("\033[91m [?] Please connect a WiFi controller and try again.")
    exit()
...
print("\033[91m [+] WiFi adapter connected!\n [*] Now let's kill conflicting processes:")
...
print("\033[91m [*] Puttinrung Wifi adapter into monitored mode:")
...
print("\033[94m <============ Press Ctrl + C at any time to abort ==============> ")
input(print("\033[91m  Attack Potential Loaded. Press Enter To Continue  "))	
...
try:
    ...
    print("\033[94m 😊😊😊 Thank you! Exiting now 😊😊😊")
time.sleep(2)
